...
public class Principal {
	...
	public static void questao5_While(Scanner scan) {
		...
		System.out.println("Soma de todos os numeros digitados: " + n + ".");
	}
	...
	public static void questao9_WhileScanner(Scanner scan) {
		...
		System.out.println("Foram digitados "+ cont + " numeros antes de parar.");
	}
	...
	public static void questao10_MetodosFor() {
		...
		// SEU CÓDIGO AQUI
	        ...
	        // Testando o método com os valores 5 e 7
